...
function CalendarDayButton({
  ...
  // Randevu yoğunluğuna göre nokta rengi belirle
  let activityDotColor = ''
  if (modifiers.lowActivity) {
    activityDotColor = 'bg-green-500' // Yeşil: 1-3 randevu
  } else if (modifiers.mediumActivity) {
    activityDotColor = 'bg-yellow-500' // Sarı: 4-6 randevu
  } else if (modifiers.highActivity) {
    activityDotColor = 'bg-red-500' // Kırmızı: 6+ randevu
  }
  ...
  return (
    ...
    >
      {props.children}
      {/* Randevu yoğunluğu göstergesi - küçük renkli nokta */}
      {activityDotColor && (
        <span
          className={cn(
